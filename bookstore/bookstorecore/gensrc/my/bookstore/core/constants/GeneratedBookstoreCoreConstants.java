...
public class GeneratedBookstoreCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String BEOINGCUSTOMCOMPONENT = "BeoingCustomComponent".intern();
		public static final String BOEINGINFO = "BoeingInfo".intern();
		public static final String BOOK = "Book".intern();
		public static final String BOOKDETAILS = "BookDetails".intern();
		public static final String CUSTOMCARTREMOVALCRONJOB = "CustomCartRemovalCronJob".intern();
		...
		public static final String SAMPLECRONJOB = "SampleCronJob".intern();
	...
	public static class Relations
	{
		...
		public static final String BOOKDETAILS2AUTHOR = "BookDetails2Author".intern();
