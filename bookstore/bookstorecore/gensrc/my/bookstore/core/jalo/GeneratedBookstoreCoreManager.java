...
import de.hybris.cronjob.jalo.SampleCronJob;
...
import my.bookstore.core.jalo.BeoingCustomComponent;
import my.bookstore.core.jalo.BoeingInfo;
import my.bookstore.core.jalo.Book;
import my.bookstore.core.jalo.BookDetails;
import my.bookstore.core.jalo.CustomCartRemovalCronJob;
...
public abstract class GeneratedBookstoreCoreManager extends Extension
{
	...
	**/
	...
	{
		return (String)item.getProperty( ctx, BookstoreCoreConstants.Attributes.Product.ALIAS);
	}
	...
	{
		item.setProperty(ctx, BookstoreCoreConstants.Attributes.Product.ALIAS,value);
	}
	...
	public BeoingCustomComponent createBeoingCustomComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( BookstoreCoreConstants.TC.BEOINGCUSTOMCOMPONENT );
			return (BeoingCustomComponent)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating BeoingCustomComponent : "+e.getMessage(), 0 );
		}
	}
	
	public BeoingCustomComponent createBeoingCustomComponent(final Map attributeValues)
	{
		return createBeoingCustomComponent( getSession().getSessionContext(), attributeValues );
	}
	
	public BoeingInfo createBoeingInfo(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( BookstoreCoreConstants.TC.BOEINGINFO );
			return (BoeingInfo)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating BoeingInfo : "+e.getMessage(), 0 );
		}
	}
	
	public BoeingInfo createBoeingInfo(final Map attributeValues)
	{
		return createBoeingInfo( getSession().getSessionContext(), attributeValues );
	}
	...
	public BookDetails createBookDetails(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( BookstoreCoreConstants.TC.BOOKDETAILS );
			return (BookDetails)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating BookDetails : "+e.getMessage(), 0 );
		}
	}
	
	public BookDetails createBookDetails(final Map attributeValues)
	{
		return createBookDetails( getSession().getSessionContext(), attributeValues );
	}
	
	public CustomCartRemovalCronJob createCustomCartRemovalCronJob(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( BookstoreCoreConstants.TC.CUSTOMCARTREMOVALCRONJOB );
			return (CustomCartRemovalCronJob)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating CustomCartRemovalCronJob : "+e.getMessage(), 0 );
		}
	}
	
	public CustomCartRemovalCronJob createCustomCartRemovalCronJob(final Map attributeValues)
	{
		return createCustomCartRemovalCronJob( getSession().getSessionContext(), attributeValues );
	}
	...
	public SampleCronJob createSampleCronJob(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( BookstoreCoreConstants.TC.SAMPLECRONJOB );
			return (SampleCronJob)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating SampleCronJob : "+e.getMessage(), 0 );
		}
	}
	
	public SampleCronJob createSampleCronJob(final Map attributeValues)
	{
		return createSampleCronJob( getSession().getSessionContext(), attributeValues );
	}
	 ...
	 * @return the rewardPoints - Number of points for product
	 */
	 ...
	 * @param value the rewardPoints - Number of points for product
	 */
